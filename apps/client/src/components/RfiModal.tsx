    ...
    <div style={modalOverlayStyle}>
      <div style={modalContentStyle}>
        ...
        <form onSubmit={onSubmit} style={{display: "flex", flexDirection: "column", gap: 16}}>
          <div>
            <label className="form-label">RFI Subject</label>
            <input 
              type="text" 
          ...
          <div>
            <label className="form-label">RFI Technical Question</label>
            <textarea 
              className="form-input" 
          ...
          <div>
            <label className="form-label">Suggested Resolution Recommendation</label>
            <textarea 
              className="form-input" 
          ...
          <div className="flex justify-end" style={{gap: 12, borderTop: "1px solid var(--border)", paddingTop: 12, marginTop: 8}}>
